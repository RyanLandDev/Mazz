...
module.exports = class extends Command {
  ...
  async run(msg, params) {
    ...
    if (amount > msg.author.settings.get('balance') || msg.author.settings.get('balance') <= 0) throw msg.send('Insufficient funds');
    if (amount <= 0) throw msg.send('Not enough bank storage! Try upgrading your bank account in the ' + msg.guild.settings.get('prefix') + 'store');
