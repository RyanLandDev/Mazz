...
module.exports = class extends Command {
  ...
  async run(message, [command]) {
    ...
    const mainCategories = getDirectories('./Mazz/src/commands');
    ...
    for (let i = 0; i < mainCategories.length; i++) {
      ...
      const subCategories = getDirectories(`./Mazz/src/commands/${mainCategories[i]}`);
    ...
    for (let i = 0; i < mainCategories.length; i++) {
      ...
      for (let i4 = 0; i4 < getDirectories(`./Mazz/src/commands/${mainCategories[i]}`).length; i4++) {
        const subCategories = getDirectories(`./Mazz/src/commands/${mainCategories[i]}`);
        description.push('');
